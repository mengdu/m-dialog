<template>
  <div>
    <div>
      ...
      <vc-button @click="handleAlertWithHTMLTitle" type="success" size="medium">Alert with HTML title</vc-button>
...
export default {
  ...
  methods: {
    ...
    handleAlertWithHTMLTitle () {
      this.$alert('Alert with HTML title', { title: '<strong>Bold title</strong>', supportHTMLString: true })
    },
    async handleConfirm () {
      for (let i = 0; i < 5; i++) {
        try {
